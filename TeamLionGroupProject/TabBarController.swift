...
class TabBarController: UITabBarController {
    ...
    func setupTabs() {
		...
		openChat.tabBarItem = UITabBarItem(title:nil, image: UIImage(named: "profileUnselected")?.imageWithRenderingMode(.AlwaysOriginal), selectedImage: UIImage(named: "profileSelected")?.imageWithRenderingMode(.AlwaysOriginal))
